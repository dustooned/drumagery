...
Latest review: 2026-05-10. The current reactive burst-effector retune checkpoint is documented in `versions/v1.3.6/VERSION.md`; the earlier reactive burst-mode checkpoint remains documented in `versions/v1.3.5/VERSION.md`, and the uploaded PNG-sequence checkpoint remains documented in `versions/v1.3/VERSION.md`.
...
The current v1 checkpoint is `versions/v1.3.6`. Freeze a fuller source snapshot only after the actual MiniLab mappings and target-device behavior are confirmed stable.
