...
export const FX_CONTROLS: FXControlConfig[] = [
  ...
  { control: "verticalRoll", label: "V Roll", defaultValue: 0, min: 0, max: 1 * FX_MAX_MULTIPLIER, step: 0.01, smoothing: 10 },
  { control: "phosphorTrail", label: "Phosphor", defaultValue: 0, min: 0, max: 1 * FX_MAX_MULTIPLIER, step: 0.01, smoothing: 6 },
  { control: "syncBands", label: "Sync Bands", defaultValue: 0, min: 0, max: 1 * FX_MAX_MULTIPLIER, step: 0.01, smoothing: 14 },
