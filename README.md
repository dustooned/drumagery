...
- `Q/W/E/R`: trigger minor/vector burst placeholders.
...
MIDI note roles:
- Major-key notes toggle persistent image-sequence loop slots.
- Minor-key/pad notes trigger short-lived procedural/vector bursts.
